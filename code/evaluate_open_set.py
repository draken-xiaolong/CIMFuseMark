...
def main() -> None:
    ...
    input_dim = graph_tensors(first, relations, device, checkpoint.get("relation_mode", "typed"),
    ...
    def fingerprint(item):
        ...
        x, edge_index, edge_type = graph_tensors(
            graph, relations, device, checkpoint.get("relation_mode", "typed"),
            checkpoint.get("feature_mode", "full"), int(config["seed"]))
